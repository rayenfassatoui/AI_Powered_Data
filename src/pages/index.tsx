    ...
    <Layout>
      <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
        ...
        <div className="relative overflow-hidden">
          {/* Animated background elements */}
          <div className="absolute inset-0">
            <div className="absolute top-0 right-0 w-1/3 h-1/3 bg-gradient-to-br from-blue-500/10 to-purple-500/10 blur-3xl rounded-full transform translate-x-1/3 -translate-y-1/4"></div>
            <div className="absolute bottom-0 left-0 w-1/3 h-1/3 bg-gradient-to-tr from-indigo-500/10 to-pink-500/10 blur-3xl rounded-full transform -translate-x-1/3 translate-y-1/4"></div>
          </div>
          ...
          <div className="relative max-w-7xl mx-auto py-24 px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              >
                <span className="inline-flex items-center px-4 py-1.5 rounded-full bg-gradient-to-r from-blue-500/10 to-indigo-500/10 text-sm font-medium text-blue-600 mb-4">
              ...
              <motion.h1
                ...
                animate={{ opacity: 1, y: 0 }}
                transition={{ delay: 0.2 }}
                className="mt-4 text-5xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600"
              >
                {session.user?.name}
              </motion.h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <motion.div
                ...
                className="group relative"
              >
                <div className="absolute inset-0 bg-gradient-to-r from-blue-500/10 to-indigo-500/10 rounded-2xl blur-xl opacity-0 group-hover:opacity-100 transition-all duration-300"></div>
                <div className="relative h-full bg-white rounded-2xl p-8 shadow-lg border border-gray-100 hover:shadow-2xl transition-all duration-300">
                  <div
                    className={`h-16 w-16 rounded-xl bg-gradient-to-r ${feature.gradient} flex items-center justify-center mb-8 shadow-lg transform group-hover:scale-110 transition-all duration-300`}
                  >
                  ...
                  <Link
                    href={feature.path}
                    className={`inline-flex items-center px-6 py-3 rounded-xl text-white bg-gradient-to-r ${feature.gradient} shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300`}
                  >
                    Get Started
                    <FiArrowRight className="ml-2 h-5 w-5 transform group-hover:translate-x-1 transition-transform duration-300" />
                  </Link>
                </div>
              </motion.div>
            ))}
